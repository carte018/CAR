...
public class RHICController {
	...
	public Response deleteInfotypes(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (! retlist.isEmpty()) {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Deleted infotypelist: " + retlist.get(0).getRhtype() + "," + retlist.get(0).getRhvalue());
			} catch (Exception e) {
	...
	public Response putInfotypes(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (retlist.isEmpty()) {
			...
			tosave = ritl;
			try {
				InformedUtility.locLog("ERR0070","Created infotypes list for " + ritl.getRhtype() + "," + ritl.getRhvalue());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Updated infotypes list for " + ritl.getRhtype() + "," + ritl.getRhvalue());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} 
	...
	public Response deleteMeatainformationRH(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (! lri.isEmpty()) {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Deleted RH metainformation: " + lri.get(0).getRhmetainfoid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
	...
	public Response putMetainformation(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (retList.isEmpty()) {
			...
			tosave = ritl;
			try {
				InformedUtility.locLog("ERR0070", "Created RH metainfo " + ritl.getRhmetainfoid() + " for " + ritl.getRhidentifier().getRhtype() + "," + ritl.getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Updated RH metainfo " + ritl.getRhmetainfoid() + " to version " + ritl.getVersion());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		}
	...
	public Response deleteRPListRH(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (! rrpl.isEmpty()) {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Deleted RP list for RH " + rrpl.get(0).getRhidentifier().getRhtype() + "," + rrpl.get(0).getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
	...
	public Response putRPListRH(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (retList.isEmpty()) {
			...
			tosave = rrpl;
			try {
				InformedUtility.locLog("ERR0070","Created RP list for " + rrpl.getRhidentifier().getRhtype() + "," + rrpl.getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Updated rP list for " + rrpl.getRhidentifier().getRhtype() + "," + rrpl.getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		}
	...
	public Response deleteIIListRH(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (! ret.isEmpty()) {
			...
			sess.close();
			try {
				InformedUtility.locLog("ERR0070","Deleted II list for " + ret.get(0).getRhidentifier().getRhtype() + "," + ret.get(0).getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
	...
	public Response putIIListRH(@Context HttpServletRequest request, @Context HttpHeaders headers, String entity, @PathParam("rhtype") String rhtype, @PathParam("rhvalue") String rhvaluein) {
		...
		if (retList.isEmpty()) {
			...
			tosave = rril;
			try {
				InformedUtility.locLog("ERR0070","Created new II list for RH " + rril.getRhidentifier().getRhtype() + "," + rril.getRhidentifier().getRhid());
			} catch (Exception e) {
				// ignore -- best effort logging
			}
		} else {
